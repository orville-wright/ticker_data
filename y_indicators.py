...
# method #2
    def get_te_zones(self):
        ...
        with requests.get( self.te_short_url, stream=True, timeout=5 ) as self.te_resp0:
        ...
        self.te_zone = self.soup.find_all(attrs={"data-yaft-module": "tdv2-applet-FullScreenChartHeader"} )
